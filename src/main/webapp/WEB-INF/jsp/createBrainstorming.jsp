...
%>
<input type="hidden" id="client" name="client" value="<%= size%>">
    <input type="text" id="topic" name="topic" placeholder="Topic Name" required/>
          <textarea placeholder="Topic Description" id="description" name="description" onkeyup="adjust_textarea(this)" required></textarea>
    <input name="submit" type="submit" value="Add Topic" />
<br><br>
  </form>
</div>
