...
<!--    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    ...
    <button style="margin-right:30px; margin-top:30px; float:left" class="button" onClick="parent.location='http://localhost:8080/welcome'">Back</button>
...
<table>
<tr><th>#</th><th>Topic</th><th>Description</th><th>Status</th><th>Start</th></tr>
...
String ret = "Select * from admin_topic where status='approve';";
...
<tr><td><%= id%></td><td><%= topic_name%></td><td><%= topic_des%></td><td><%= status%></td><td><button onClick="updatefun()" id="<%= id%>">Start</button></td></tr>
 ...
 function updatefun(){
     ...
     window.location = "http://localhost:8080/finalchatwindow?value=" + btn.id + "&role=admin";
